...
var AcePopup = function(parentNode) {
    ...
    bgTokenizer.$tokenizeRow = function(row) {
        ...
        if (data.meta) {
            ...
            var metaStyle = 'rightAlignedText';
            if (metaData.length + data.caption.length > maxW - 2) {
                metaData = metaData.substr(0, maxW - data.caption.length - 3) + "\u2026"
            }

            if (metaData.indexOf("{") !== -1) {
            	if (metaData.indexOf("Required") !== -1)
            		metaStyle = 'smartAPIsnippet';
            	else
            		metaStyle = 'smartAPIsnippetShould';
            	}
			else {
			    if (data.smartAPIlevel.indexOf("may") !== -1)
            		metaStyle = 'smartAPImay';
               else if (data.smartAPIlevel.indexOf("should") !== -1)
            	    metaStyle = 'smartAPIshould';
            	}
            tokens.push({type: metaStyle, value: metaData});
...
.ace_editor.tooltip {\
  ...
  .ace_editor.hover:hover .tooltip {\
    opacity:1;\
}\
}");
        ...
        if (data.completer && data.completer.insertMatch) {
            ...
            if (data.snippet){
              ...
              if (data.value.indexOf("http://") !== -1){
                this.editor.removeToLineStart();
                this.editor.execCommand("insertstring", '- ');
                }
                this.editor.execCommand("insertstring", data.value || data+": ");
                }
                /*if (data.value === "responseDataType") {
                	this.editor.execCommand("insertstring", "# Press Ctrl-Space and hit return! The profiler will open on the right side.");
                	}*/
        }
        this.detach();
    };
